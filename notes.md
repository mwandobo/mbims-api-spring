...
db2 "REORG TABLE PROFITS.GLI_TRX_EXTRACT ALLOW NO ACCESS"


db2 "RUNSTATS ON TABLE PROFITS.GLI_TRX_EXTRACT
WITH DISTRIBUTION AND DETAILED INDEXES ALL
ALLOW WRITE ACCESS"


db2 "CREATE INDEX PROFITS.IDX_GLI_TRX_CUST_ID ON PROFITS.GLI_TRX_EXTRACT (CUST_ID)"
db2 "CREATE INDEX PROFITS.IDX_GLI_TRX_CUST_DATE ON PROFITS.GLI_TRX_EXTRACT (CUST_ID, TRN_DATE DESC)"
db2 "CREATE INDEX PROFITS.IDX_GLI_TRX_EXTERNAL_GL ON PROFITS.GLI_TRX_EXTRACT (EXTERNAL_GLACCOUNT)"
